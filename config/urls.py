...
urlpatterns = [
    ...
    path('users/friend', views.FriendList.as_view(), name='friend-list'),
    path('cards/favorite', views.FavoriteList.as_view(), name='favorite-list'),
    path('cards/favorite/add', views.FavoriteAdd.as_view(), name='favorite-add'),
